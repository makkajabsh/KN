...
- **Waktu:** 2026-09-22 12:06:09
- **Mode:** `full`  ·  **Durasi total:** 395s  ·  **Pekerja statik:** 2
...
| guard:modal_dismiss (INV-UI-01, modal auto-close) | PASS (1s) |
...
| guard:list_export (INV-UI-07, daftar berhalaman wajib bisa diunduh) | PASS (2s) |
...
| guard:picker_portal SELF-TEST (bukti-merah + anti tuduh palsu, 16 kasus) | PASS (7s) |
...
| guard:atomic_claim SELF-TEST (bukti-merah dua arah, 10 kasus) | FAIL (3s) |
...
| audit_sales_roles_ux (SEMUA peran: nol layar & panel mati) | FAIL (51s) |
...
| INV-GATE-01 anti-residu (gate tak boleh merusak data) | FAIL (0s) |
...
| POC FASE G-6 (antar entitas · dokumen kembar · netting · eliminasi margin) | PASS (10s) |
| POC FASE G-6b (faktur pajak internal · retur antar-PT · pengingat · margin) | PASS (13s) |
